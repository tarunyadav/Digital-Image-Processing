...
#			for i in range(0,size[0],1):
#			    for j in range(0,size[1],1):
#			   	    if ((image_array[i][j][0] >  THRESHOLD and image_array[i][j][1] >  THRESHOLD) or (image_array[i][j][1] >  THRESHOLD and image_array[i][j][2] >  THRESHOLD) or (image_array[i][j][2] >  THRESHOLD and image_array[i][j][0] >  THRESHOLD)) :
#			   	    	image_arr[i][j][0] = 255
#			   	    	image_arr[i][j][1] = 255
#			   	    	image_arr[i][j][2] = 255			   	    				   	    	
#			   	    else:
...
# Image formed based on distance from original image pixels. Images points are shown in black and affinity toward white as distance increases from the image.
