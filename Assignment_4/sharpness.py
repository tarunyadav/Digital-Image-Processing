## 
 ...
 # ----------------------------------------------------------------
 #
 #          Script to apply sharping to images
...
##Laplace Operator
	...
	method_used = int(raw_input("\nPress 1 for sharpening using 4 neightbor approach : "+"\nPress 2 for edge sharpening using 8 neightbor approach : \n"))
	C = float(raw_input("Type the constact C for sharpening (Original - C*Laplacian) :\n"))
